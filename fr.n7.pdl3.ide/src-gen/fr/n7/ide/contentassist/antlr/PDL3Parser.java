...
public class PDL3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProcessAccess().getWorkSequencesAssignment_10(), "rule__Process__WorkSequencesAssignment_10");
			builder.put(grammarAccess.getProcessAccess().getWorkSequencesAssignment_11_1(), "rule__Process__WorkSequencesAssignment_11_1");
