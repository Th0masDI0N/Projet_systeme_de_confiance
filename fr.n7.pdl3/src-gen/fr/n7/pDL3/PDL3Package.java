...
public interface PDL3Package extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Work Definitions</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * Returns the meta object for the attribute list '{@link fr.n7.pDL3.Process#getWorkDefinitions <em>Work Definitions</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Work Definitions</em>'.
   * @see fr.n7.pDL3.Process#getWorkDefinitions()
   * @see #getProcess()
   * @generated
   */
  EAttribute getProcess_WorkDefinitions();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Work Definitions</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute PROCESS__WORK_DEFINITIONS = eINSTANCE.getProcess_WorkDefinitions();
