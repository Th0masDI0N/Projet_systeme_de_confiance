 ...
 *   <li>{@link fr.n7.pDL1.impl.RessourceImpl#getNbRessourceDisponible <em>Nb Ressource Disponible</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RessourceImpl extends ProcessElementImpl implements Ressource
{
  ...
  public void setNbRessourceDisponible(int newNbRessourceDisponible)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL1Package.RESSOURCE__NB_RESSOURCE_DISPONIBLE, oldNbRessourceDisponible, nbRessourceDisponible));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDL1Package.RESSOURCE__NAME:
        return getName();
      case PDL1Package.RESSOURCE__NB_RESSOURCE_DISPONIBLE:
