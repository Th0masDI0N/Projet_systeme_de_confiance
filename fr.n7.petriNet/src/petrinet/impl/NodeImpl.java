 ...
 *   <li>{@link petrinet.impl.NodeImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link petrinet.impl.NodeImpl#getOutgoing <em>Outgoing</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NodeImpl extends PetriElementImpl implements Node {
	/**
	...
	public EList<Arc> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, PetrinetPackage.NODE__INCOMING, PetrinetPackage.ARC__TARGET);
		}
		return incoming;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.NODE__INCOMING:
