...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	public EList<PetriElement> getPetriElements() {
		if (petriElements == null) {
			petriElements = new EObjectContainmentWithInverseEList<PetriElement>(PetriElement.class, this, PetrinetPackage.PETRI_NET__PETRI_ELEMENTS, PetrinetPackage.PETRI_ELEMENT__PETRINET);
		}
