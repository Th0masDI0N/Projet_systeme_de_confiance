...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 */
	@Override
	public EReference getWorkDefinition_ResourceUsages() {
	 ...
	 */
	@Override
	public EReference getRessourceAllocation_Task() {
		return (EReference)ressourceAllocationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getRessourceAllocation_Quantity() {
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__RESOURCE_USAGES);
		...
		createEReference(ressourceAllocationEClass, RESSOURCE_ALLOCATION__TASK);
		createEReference(ressourceAllocationEClass, RESSOURCE_ALLOCATION__RESSOURCE);
		createEAttribute(ressourceAllocationEClass, RESSOURCE_ALLOCATION__QUANTITY);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_ResourceUsages(), this.getRessourceAllocation(), this.getRessourceAllocation_Task(), "resourceUsages", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessourceAllocation_Task(), this.getWorkDefinition(), this.getWorkDefinition_ResourceUsages(), "task", null, 1, 1, RessourceAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourceAllocation_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, RessourceAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRessourceAllocation_Quantity(), ecorePackage.getEInt(), "quantity", null, 1, 1, RessourceAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
