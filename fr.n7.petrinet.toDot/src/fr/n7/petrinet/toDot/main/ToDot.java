...
public class ToDot extends AbstractAcceleoGenerator {
	...
	public void registerPackages(ResourceSet resourceSet) {
        // 1) Laisser Acceleo enregistrer les siens
        super.registerPackages(resourceSet);

        // 2) Factory pour lire les .xmi
        resourceSet.getResourceFactoryRegistry()
            .getExtensionToFactoryMap()
            .put("xmi", new XMIResourceFactoryImpl());

        // 3) Enregistrement du package Petrinet
        resourceSet.getPackageRegistry()
            .put(PetrinetPackage.eNS_URI, PetrinetPackage.eINSTANCE);
    }
